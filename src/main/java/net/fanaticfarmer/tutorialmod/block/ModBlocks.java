package net.fanaticfarmer.tutorialmod.block;

import net.fabricmc.fabric.api.itemgroup.v1.ItemGroupEvents;
import net.fanaticfarmer.tutorialmod.TutorialMod;
import net.fanaticfarmer.tutorialmod.block.custom.MagicBlock;
import net.fanaticfarmer.tutorialmod.block.custom.PinkGarnetLampBlock;
...
public class ModBlocks {
    ...
    public static final Block PINK_GARNET_BLOCK = registerBlock("pink_garnet_block",
            new Block(AbstractBlock.Settings.create().strength(3, 3)
    ...
    public static final Block PINK_GARNET_ORE = registerBlock("pink_garnet_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(2, 5),
                    AbstractBlock.Settings.create().strength(3, 3).requiresTool()));
    public static final Block PINK_GARNET_DEEPSLATE_ORE = registerBlock("pink_garnet_deepslate_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(2, 5),
                    AbstractBlock.Settings.create().strength(3, 3).requiresTool().sounds(BlockSoundGroup.DEEPSLATE)));
